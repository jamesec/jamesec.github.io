...
I was looking for a lightweight web browser, and I tried many of them. I wanted something that isn’t bulky and doesn’t spy on me or collect too much information—especially without my consent. I found [Ungoogled Chromium](/o/s.htm?p=ungoogled), which is really good, and more recently I discovered [Helium browser](https://helium.computer/)—it rocks!
...
Overall, I’m very satisfied with Helium browser. It fixes Ungoogled Chromium’s main drawback: it can’t update itself (except via Homebrew on macOS, that is, `brew upgrade --cask ungoogled-chromium`). 

After several months of use, Helium does what it promises: a private, fast, and honest web browser.
